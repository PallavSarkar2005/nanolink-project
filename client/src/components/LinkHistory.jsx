...
const LinkHistory = ({ history, onClear }) => {
            ...
            >
              <div className="truncate pr-4 text-left">
                <div className="flex items-center gap-2 mb-1">
                  <p className="text-indigo-400 font-bold truncate tracking-tight">{item.shortUrl}</p>
                ...
                <p className="text-slate-500 text-xs truncate font-medium">{item.longUrl}</p>
              </div>
              ...
              <div className="flex gap-2 shrink-0">
                ...
                <motion.a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="p-2.5 bg-indigo-600/10 hover:bg-indigo-600/20 rounded-xl text-indigo-400 hover:text-indigo-300 transition-all border border-indigo-500/20"
                  title="Open Link"
                >
